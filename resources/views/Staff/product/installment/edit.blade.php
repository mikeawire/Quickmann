...
@endphp
    ...
    <div class="col-lg-4">
     ...
     <p>&#8358;{{$cp->unpaid_balance}}</p> 
        ...
        @endif
       @if(Auth::user()->staffprofile->role =='MD'|| Auth::user()->staffprofile->role =='EA' || Auth::user()->staffprofile->role =='CFO' ||  Auth::user()->staffprofile->role =='COO')
     
        <div>
             <h5 style="color: #000;" class="p-2"><b>Edit Property Price Details</b></h5>
<form method="POST" action="{{ route('installmentsales.update',$cp->id) }}" accept-charset="UTF-8" class="form-horizontal" role="form">
{{ csrf_field() }}
<input type="hidden" name="_method" value="PUT">
<div class="mt-5  text-center">

 <input type="number" name="price" class="form-control" value="{{$plot->price}}">
...
<button class="btn btn-sm btn-success" onclick="return confirm('Are you sure want to change property Details?')" >Update</button>
