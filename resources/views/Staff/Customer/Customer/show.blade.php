...
{{
$count=1;
$cps =DB::table('customer_properties')->where('customer_id',$customer->id)->orderBy('created_at','DESC')->get();
...
@endphp
    ...
    @php
{{
      $staffs =DB::table('staff_profiles')->where('reg_no',$cp->dro_reg_no)->get(); 
...
@if($cp->property_status=='own')
<p class="text-success"><b>Status</b>
Product Completely Sold to this Customer
</p>
@elseif($cp->property_status=='preown')
<p class="text-warning"><b>Status</b>
Product Under Installment</p>

@elseif($cp->property_status=='revoked')
<p class="text-danger"><b>Status</b>
Product have been Revoked From This Customer
</p>
@endif
</p>
