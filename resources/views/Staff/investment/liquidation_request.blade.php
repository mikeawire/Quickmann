...
@section('title', 'Liquidation request list')
@section('css')
...
<td class="p_deposit">
                         ...
                         <form action="{{ route('liquidation_request.approve',$dp->inv_id) }}" method="POST">
<input name="_method" type="hidden" value="PATCH">
                                    {{ csrf_field() }}

                        <button onclick="return confirm('Are you sure want to approve liquidation request?')"
