...
<html lang="en">
<head>
	   <title>{{ config('app.name', 'Quickmann App') }} Login</title>
	       @laravelPWA
	<meta charset="UTF-8">
...
<a href="/findproperty">	<button class="login100-form-btn " style="font-size:15px;"type="button">Find Shelter</button></a>
	</div>
