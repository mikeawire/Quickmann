...
return [
    ...
    */
    ...
    'logo' => '<b>Quick</b>Access',
    'logo_img' => '/images/bg-3.jpeg',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Quickaccess',
...
'submenu' => [
    ...
    [
     ...
     [
        'text' => 'Revoked Fund',
        'url'  => '/customerrevoke/show',
        'icon' => 'fas fa-fw fa-circle',
        'icon_color' => 'success',
    ],

      [
        'text' => 'Search Defaulters',

        'url'  => '/defaulters/create',
...
'submenu' => [
    ...
    [
        'text' => 'Property und. Install',

        'url'  => 'installmentsales',
        'icon' => 'fas fa-fw fa-circle',
        'icon_color' => 'yellow',
    ],
    [
